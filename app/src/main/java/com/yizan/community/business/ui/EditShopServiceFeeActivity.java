...
public class EditShopServiceFeeActivity extends BaseActivity implements BaseActivity.TitleListener {
    private ShopInfo mShopInfo;
    private EditText mEditText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_shop_service_fee);
        ...
        mEditText.setText(String.valueOf(mShopInfo.serviceFee));
        setPageTag(TagManage.EDIT_SHOP_SERVICE_FEE_ACTIVITY);
    }


    @Override
    public void setTitle(TextView title, ImageButton left, View right) {
        title.setText(R.string.title_activity_edit_shop_service_fee);
    ...
    private void editShop(){
        ...
        if(TextUtils.isEmpty(value)){
            mShopInfo.serviceFee = 0;
        }else{
            try {
                mShopInfo.serviceFee = Double.parseDouble(value);
            }catch (Exception e){
        ...
        ApiUtils.post(this, URLConstants.SHOP_EDIT, data, ShopResult.class, new Response.Listener<ShopResult>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ToastUtils.show(EditShopServiceFeeActivity.this, R.string.msg_error_update);
                CustomDialogFragment.dismissDialog();
            }
        });
    }
