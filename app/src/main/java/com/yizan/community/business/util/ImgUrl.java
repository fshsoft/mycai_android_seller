...
import com.yizan.community.business.YizanApplication;
...
public class ImgUrl {
    ...
    public static String scaleUrl(int wDimenId, int hDimenId, String url) {
        int width = (int) YizanApplication.getInstance().getResources().getDimension(wDimenId);
        int height = (int) YizanApplication.getInstance().getResources().getDimension(hDimenId);
        return formatUrl(width, height, url);
    }

    public static String heightUrl(int dimenId, String url) {
        int height = (int) YizanApplication.getInstance().getResources().getDimension(dimenId);
        return formatUrl(-1, height, url);
    }

    public static String widthUrl(int dimenId, String url) {
        int width = (int) YizanApplication.getInstance().getResources().getDimension(dimenId);
