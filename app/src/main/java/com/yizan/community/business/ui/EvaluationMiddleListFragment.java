 ...
 */
public class EvaluationMiddleListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setPageTag(TagManage.EVALUATION_MIDDLE_LIST_FRAGMENT);
	}
	...
	private void loadData(final boolean isRefresh) {
		if (NetworkUtils.isNetworkAvaiable(mFragmentActivity)) {
			...
			data.put(ParamConstants.TYPE, String.valueOf(2));
